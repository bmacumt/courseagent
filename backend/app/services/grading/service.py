"""Grading service: wraps GradingAgent with DB persistence."""
import json
import logging

from app.config import CHROMA_PATH
from app.services.grading.agent import GradingAgent
from app.services.grading.models import GradingCriteria
...
class GradingService:
    ...
    async def run_grading(self, submission_id: int, session) -> None:
        ...
        from app.db.models import Assignment, Submission, Report
