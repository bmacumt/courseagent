...
from server.auth.jwt import create_access_token, decode_access_token, hash_password, verify_password
from server.db.engine import async_session, init_db, engine
from server.db.models import Base, User, Assignment, Submission, Report, Document, Setting
...
def setup_db(db_path: str):
    ...
    import server.db.engine as eng
...
def main():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        from server.db.engine import get_session as _orig_get_session

        async def _test_get_session():
            from server.db.engine import async_session
