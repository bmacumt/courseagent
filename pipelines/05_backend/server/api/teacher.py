...
from server.db.engine import get_session, async_session
from server.db.models import User, Document, Assignment, Submission, Report
...
def _default_criteria_json() -> str:
    from grading.models import DEFAULT_CRITERIA
