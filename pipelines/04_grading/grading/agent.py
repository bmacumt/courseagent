...
from grading.models import DEFAULT_CRITERIA, DimensionResult, GradingCriteria, GradingReport
from grading.rag_bridge import RAGBridge
from grading.scorer import check_regulations, generate_feedback, score_dimension

# Add 03_rag to sys.path for LLMClient import
...
class GradingAgent:
    ...
    async def grade(
        ...
        for dim in criteria.dimensions:
            dim_regulations = regulations_text if dim.name == "compliance" else None
