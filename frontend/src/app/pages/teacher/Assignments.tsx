...
const defaultDimensions: Dimension[] = [
  { name: 'knowledge_integration', label: '知识整合', weight: 0.20, description: '对领域知识的理解深度、文献梳理、逻辑框架、概念体系化程度' },
  { name: 'comprehensive_literacy', label: '综合素养', weight: 0.20, description: '结构完整性、语言表达、引用规范、逻辑严谨性、学术态度' },
  { name: 'innovative_thinking', label: '创新思维', weight: 0.20, description: '观点新颖性、研究视角、方法改进、提出新问题/新结论的能力' },
  { name: 'application_extension', label: '应用拓展', weight: 0.20, description: '理论联系实际、问题解决能力、实践价值、落地可行性、场景迁移' },
  { name: 'analytical_reasoning', label: '分析论证', weight: 0.20, description: '数据分析、推理严密性、论据充分度、批判性思考、结论可靠性' },
];
